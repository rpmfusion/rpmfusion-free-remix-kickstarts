...
rpm -qa --qf '%{NAME} %{SIGGPG:pgpsig} %{SIGPGP:pgpsig} \n' | grep -e 7f9dec5ea3780952 -e adc570de00a4d52b -e 657c3396adf25d9c | awk ' { print $1 } ' | sort
echo "List of incuded RPM Fusion packages with their size:"
rpm -q --qf '%{SIZE} %{NAME}\n' $(rpm -qa --qf '%{NAME} %{SIGGPG:pgpsig} %{SIGPGP:pgpsig} \n' | grep -e 7f9dec5ea3780952 -e adc570de00a4d52b -e 657c3396adf25d9c| awk ' { print $1 } ') | sort -n
echo
%end
